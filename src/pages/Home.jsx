  ...
  return (
    <div>
      ...
      <div className="w-1/2 space-y-6">
        ...
        <div className="ml-10">
          <Button text="Book appointment" imgSrc={assets.arrow_icon} imgAlt="Arrow icon" className="bg-white" />
        </div>
    ...
    <section className="py-16 px-6 pt-40 text-center">
      ...
      <div className="ml-10 flex justify-center">
        <Button className="pl-20 pr-20 bg-gray-100" text="more" />
      </div>
    ...
    <section className="hr-bg rounded-lg  relative max-w-screen-lg mx-auto">
      ...
      <div className="pl-10 pr-10 flex justify-between items-center">
        ...
        <div className="w-full md:w-1/2 text-white">
          ...
          <div className="ml-10">
          <Button text="Create account" className="pl-10 bg-white pr-4" />
        </div>
        </div>
